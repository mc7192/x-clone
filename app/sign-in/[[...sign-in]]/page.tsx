...
const page = () => {
  return (
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full lg:1/2 flex flex-col gap-4">
        ...
        <SignIn.Root>
          <Clerk.Connection
            name="google"
            className="bg-white rounded-full p-2 text-black w-72 flex items-center justify-center gap-2 font-bols"
          >
          ...
          <SignIn.Step name="start">
            ...
            <SignIn.Action
              submit
              className="mt-2 text-sm underline w-72 text-center text-icon-blue"
            >
              Continue
            </SignIn.Action>
          </SignIn.Step>
          ...
          >
            <SignIn.SupportedStrategy name="reset_password_email_code">
              <span className="underline text-icon-blue">Reset password</span>
          ...
          <div className="w-72 flex items-center gap-4">
            <div className="h-px bg-border-gray flex-grow"></div>
            <span className="text-gray">or</span>
            <div className="h-px bg-border-gray flex-grow"></div>
          </div>
          <Link
            href="/sign-up"
            className="bg-icon-blue rounded-full p-2 text-white font-bold w-72 text-center"
          >
            Create Account
          </Link>
          <p className="w-72 text-xs">
            By signing up, you agree to the{" "}
            <span className="text-icon-blue">Terms of Service</span> and{" "}
            <span className="text-icon-blue">Privacy Policy</span>, including{" "}
            <span className="text-icon-blue">Cookie</span> use.
          </p>
        </SignIn.Root>
      </div>
    </div>
